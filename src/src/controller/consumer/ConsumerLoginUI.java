...
public class ConsumerLoginUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsumerLoginUI frame = new ConsumerLoginUI();
	...
	public ConsumerLoginUI() {
		...
		JLabel lblNewLabel_2 = new JLabel("顧客 登入畫面");
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					if (consumer!=null) {
						...
						FileUtils.save(new Employee(), "employee.txt");
		...
		btnRegister.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				new ConsumerRegisterUI().setVisible(true);
				dispose(); // 關閉登入視窗
			}
		});
